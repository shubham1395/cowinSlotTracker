...
class QSvgGenerator(PySide6.QtGui.QPaintDevice):
    ...
    @typing.overload
    def setViewBox(self, viewBox:PySide6.QtCore.QRectF) -> None: ...
...
class QSvgRenderer(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, contents:PySide6.QtCore.QByteArray, parent:typing.Optional[PySide6.QtCore.QObject]=...) -> None: ...
    @typing.overload
    def __init__(self, contents:PySide6.QtCore.QXmlStreamReader, parent:typing.Optional[PySide6.QtCore.QObject]=...) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def load(self, contents:PySide6.QtCore.QByteArray) -> bool: ...
    @typing.overload
    ...
    @typing.overload
    def render(self, p:PySide6.QtGui.QPainter, bounds:PySide6.QtCore.QRectF) -> None: ...
    @typing.overload
    def render(self, p:PySide6.QtGui.QPainter, elementId:str, bounds:PySide6.QtCore.QRectF=...) -> None: ...
