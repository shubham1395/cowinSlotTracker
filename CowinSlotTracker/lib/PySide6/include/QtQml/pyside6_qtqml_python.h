...
enum : int {
    ...
    SBK_QJSENGINE_IDX                                        = 2,
    SBK_QJSVALUE_SPECIALVALUE_IDX                            = 7,
    SBK_QJSVALUE_ERRORTYPE_IDX                               = 6,
    SBK_QJSVALUE_IDX                                         = 5,
    SBK_QJSVALUEITERATOR_IDX                                 = 8,
    ...
    SBK_QQMLMODULEIMPORTSPECIALVERSIONS_IDX                  = 34,
...
enum : int {
    ...
    SBK_QTQML_QMAP_QSTRING_QVARIANT_IDX                      = 1, // const QMap<QString,QVariant > &
    SBK_QTQML_QHASH_QSTRING_QVARIANT_IDX                     = 2, // const QHash<QString,QVariant > &
    SBK_QTQML_QLIST_QJSVALUE_IDX                             = 3, // const QList<QJSValue > &
    SBK_QTQML_QLIST_QOBJECTPTR_IDX                           = 4, // const QList<QObject* > &
