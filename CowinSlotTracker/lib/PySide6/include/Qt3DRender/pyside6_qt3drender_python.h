...
enum : int {
    ...
    SBK_QT3DRENDER_QDEPTHTEST_DEPTHFUNCTION_IDX              = 44,
    SBK_QT3DRENDER_QDEPTHTEST_IDX                            = 43,
    SBK_QT3DRENDER_QDIRECTIONALLIGHT_IDX                     = 45,
    SBK_QT3DRENDER_QDISPATCHCOMPUTE_IDX                      = 46,
    SBK_QT3DRENDER_QDITHERING_IDX                            = 47,
    SBK_QT3DRENDER_QEFFECT_IDX                               = 48,
    SBK_QT3DRENDER_QENVIRONMENTLIGHT_IDX                     = 49,
    SBK_QT3DRENDER_QFILTERKEY_IDX                            = 50,
    SBK_QT3DRENDER_QFRAMEGRAPHNODE_IDX                       = 51,
    SBK_QT3DRENDER_QFRONTFACE_WINDINGDIRECTION_IDX           = 53,
    SBK_QT3DRENDER_QFRONTFACE_IDX                            = 52,
    SBK_QT3DRENDER_QFRUSTUMCULLING_IDX                       = 54,
    SBK_QT3DRENDER_QGEOMETRYRENDERER_PRIMITIVETYPE_IDX       = 56,
    SBK_QT3DRENDER_QGEOMETRYRENDERER_IDX                     = 55,
    SBK_QT3DRENDER_QGRAPHICSAPIFILTER_API_IDX                = 58,
    SBK_QT3DRENDER_QGRAPHICSAPIFILTER_OPENGLPROFILE_IDX      = 59,
    SBK_QT3DRENDER_QGRAPHICSAPIFILTER_IDX                    = 57,
    SBK_QT3DRENDER_QLAYER_IDX                                = 60,
    SBK_QT3DRENDER_QLAYERFILTER_FILTERMODE_IDX               = 62,
    SBK_QT3DRENDER_QLAYERFILTER_IDX                          = 61,
    SBK_QT3DRENDER_QLEVELOFDETAIL_THRESHOLDTYPE_IDX          = 64,
    SBK_QT3DRENDER_QLEVELOFDETAIL_IDX                        = 63,
    SBK_QT3DRENDER_QLEVELOFDETAILBOUNDINGSPHERE_IDX          = 65,
    SBK_QT3DRENDER_QLEVELOFDETAILSWITCH_IDX                  = 66,
    SBK_QT3DRENDER_QLINEWIDTH_IDX                            = 67,
    SBK_QT3DRENDER_QMATERIAL_IDX                             = 68,
    SBK_QT3DRENDER_QMEMORYBARRIER_OPERATION_IDX              = 70,
    SBK_QFLAGS_QT3DRENDER_QMEMORYBARRIER_OPERATION_IDX       = 1,
    SBK_QT3DRENDER_QMEMORYBARRIER_IDX                        = 69,
    SBK_QT3DRENDER_QMESH_STATUS_IDX                          = 72,
    SBK_QT3DRENDER_QMESH_IDX                                 = 71,
    SBK_QT3DRENDER_QMULTISAMPLEANTIALIASING_IDX              = 73,
    SBK_QT3DRENDER_QNODEPTHMASK_IDX                          = 74,
    SBK_QT3DRENDER_QNODRAW_IDX                               = 75,
    SBK_QT3DRENDER_QNOPICKING_IDX                            = 76,
    SBK_QT3DRENDER_QOBJECTPICKER_IDX                         = 77,
    SBK_QT3DRENDER_QPAINTEDTEXTUREIMAGE_IDX                  = 78,
    SBK_QT3DRENDER_QPARAMETER_IDX                            = 79,
    SBK_QT3DRENDER_QPICKEVENT_BUTTONS_IDX                    = 81,
    SBK_QT3DRENDER_QPICKEVENT_MODIFIERS_IDX                  = 82,
    SBK_QT3DRENDER_QPICKEVENT_IDX                            = 80,
    SBK_QT3DRENDER_QPICKLINEEVENT_IDX                        = 83,
    SBK_QT3DRENDER_QPICKPOINTEVENT_IDX                       = 84,
    SBK_QT3DRENDER_QPICKTRIANGLEEVENT_IDX                    = 85,
    SBK_QT3DRENDER_QPICKINGSETTINGS_PICKMETHOD_IDX           = 88,
    SBK_QT3DRENDER_QPICKINGSETTINGS_PICKRESULTMODE_IDX       = 89,
    SBK_QT3DRENDER_QPICKINGSETTINGS_FACEORIENTATIONPICKINGMODE_IDX = 87,
    SBK_QT3DRENDER_QPICKINGSETTINGS_IDX                      = 86,
    SBK_QT3DRENDER_QPOINTLIGHT_IDX                           = 90,
    SBK_QT3DRENDER_QPOINTSIZE_SIZEMODE_IDX                   = 92,
    SBK_QT3DRENDER_QPOINTSIZE_IDX                            = 91,
    SBK_QT3DRENDER_QPOLYGONOFFSET_IDX                        = 93,
    SBK_QT3DRENDER_QPROXIMITYFILTER_IDX                      = 94,
    SBK_QT3DRENDER_QRAYCASTER_IDX                            = 95,
    SBK_QT3DRENDER_QRAYCASTERHIT_HITTYPE_IDX                 = 97,
    SBK_QT3DRENDER_QRAYCASTERHIT_IDX                         = 96,
    SBK_QT3DRENDER_QRENDERASPECT_SUBMISSIONTYPE_IDX          = 99,
    SBK_QT3DRENDER_QRENDERASPECT_IDX                         = 98,
    SBK_QT3DRENDER_QRENDERCAPABILITIES_API_IDX               = 101,
    SBK_QT3DRENDER_QRENDERCAPABILITIES_PROFILE_IDX           = 102,
    SBK_QT3DRENDER_QRENDERCAPABILITIES_IDX                   = 100,
    SBK_QT3DRENDER_QRENDERCAPTURE_IDX                        = 103,
    SBK_QT3DRENDER_QRENDERCAPTUREREPLY_IDX                   = 104,
    SBK_QT3DRENDER_QRENDERPASS_IDX                           = 105,
    SBK_QT3DRENDER_QRENDERPASSFILTER_IDX                     = 106,
    SBK_QT3DRENDER_QRENDERSETTINGS_RENDERPOLICY_IDX          = 108,
    SBK_QT3DRENDER_QRENDERSETTINGS_IDX                       = 107,
    SBK_QT3DRENDER_QRENDERSTATE_IDX                          = 109,
    SBK_QT3DRENDER_QRENDERSTATESET_IDX                       = 110,
    SBK_QT3DRENDER_QRENDERSURFACESELECTOR_IDX                = 111,
    SBK_QT3DRENDER_QRENDERTARGET_IDX                         = 112,
    SBK_QT3DRENDER_QRENDERTARGETOUTPUT_ATTACHMENTPOINT_IDX   = 114,
    SBK_QT3DRENDER_QRENDERTARGETOUTPUT_IDX                   = 113,
    SBK_QT3DRENDER_QRENDERTARGETSELECTOR_IDX                 = 115,
    SBK_QT3DRENDER_QSCENELOADER_STATUS_IDX                   = 118,
    SBK_QT3DRENDER_QSCENELOADER_COMPONENTTYPE_IDX            = 117,
    SBK_QT3DRENDER_QSCENELOADER_IDX                          = 116,
    SBK_QT3DRENDER_QSCISSORTEST_IDX                          = 119,
    SBK_QT3DRENDER_QSCREENRAYCASTER_IDX                      = 120,
    SBK_QT3DRENDER_QSEAMLESSCUBEMAP_IDX                      = 121,
    SBK_QT3DRENDER_QSETFENCE_HANDLETYPE_IDX                  = 123,
    SBK_QT3DRENDER_QSETFENCE_IDX                             = 122,
    SBK_QT3DRENDER_QSHADERDATA_IDX                           = 124,
    SBK_QT3DRENDER_QSHADERIMAGE_ACCESS_IDX                   = 126,
    SBK_QT3DRENDER_QSHADERIMAGE_IMAGEFORMAT_IDX              = 127,
    SBK_QT3DRENDER_QSHADERIMAGE_IDX                          = 125,
    SBK_QT3DRENDER_QSHADERPROGRAM_SHADERTYPE_IDX             = 130,
    SBK_QT3DRENDER_QSHADERPROGRAM_STATUS_IDX                 = 131,
    SBK_QT3DRENDER_QSHADERPROGRAM_FORMAT_IDX                 = 129,
    SBK_QT3DRENDER_QSHADERPROGRAM_IDX                        = 128,
    SBK_QT3DRENDER_QSHADERPROGRAMBUILDER_IDX                 = 132,
    SBK_QT3DRENDER_QSHAREDGLTEXTURE_IDX                      = 133,
    SBK_QT3DRENDER_QSORTPOLICY_SORTTYPE_IDX                  = 135,
    SBK_QT3DRENDER_QSORTPOLICY_IDX                           = 134,
    SBK_QT3DRENDER_QSPOTLIGHT_IDX                            = 136,
    SBK_QT3DRENDER_QSTENCILMASK_IDX                          = 137,
    SBK_QT3DRENDER_QSTENCILOPERATION_IDX                     = 138,
    SBK_QT3DRENDER_QSTENCILOPERATIONARGUMENTS_FACEMODE_IDX   = 140,
    SBK_QT3DRENDER_QSTENCILOPERATIONARGUMENTS_OPERATION_IDX  = 141,
    SBK_QT3DRENDER_QSTENCILOPERATIONARGUMENTS_IDX            = 139,
    SBK_QT3DRENDER_QSTENCILTEST_IDX                          = 142,
    SBK_QT3DRENDER_QSTENCILTESTARGUMENTS_STENCILFACEMODE_IDX = 144,
    SBK_QT3DRENDER_QSTENCILTESTARGUMENTS_STENCILFUNCTION_IDX = 145,
    SBK_QT3DRENDER_QSTENCILTESTARGUMENTS_IDX                 = 143,
    SBK_QT3DRENDER_QTECHNIQUE_IDX                            = 146,
    SBK_QT3DRENDER_QTECHNIQUEFILTER_IDX                      = 147,
    SBK_QT3DRENDER_QTEXTURE1D_IDX                            = 148,
    SBK_QT3DRENDER_QTEXTURE1DARRAY_IDX                       = 149,
    SBK_QT3DRENDER_QTEXTURE2D_IDX                            = 150,
    SBK_QT3DRENDER_QTEXTURE2DARRAY_IDX                       = 151,
    SBK_QT3DRENDER_QTEXTURE2DMULTISAMPLE_IDX                 = 152,
    SBK_QT3DRENDER_QTEXTURE2DMULTISAMPLEARRAY_IDX            = 153,
    SBK_QT3DRENDER_QTEXTURE3D_IDX                            = 154,
    SBK_QT3DRENDER_QTEXTUREBUFFER_IDX                        = 155,
    SBK_QT3DRENDER_QTEXTURECUBEMAP_IDX                       = 156,
    SBK_QT3DRENDER_QTEXTURECUBEMAPARRAY_IDX                  = 157,
    SBK_QT3DRENDER_QTEXTUREDATA_IDX                          = 158,
    SBK_QT3DRENDER_QTEXTUREIMAGE_STATUS_IDX                  = 160,
    SBK_QT3DRENDER_QTEXTUREIMAGE_IDX                         = 159,
    SBK_QT3DRENDER_QTEXTUREIMAGEDATA_IDX                     = 161,
    SBK_QT3DRENDER_QTEXTUREIMAGEDATAGENERATOR_IDX            = 162,
    SBK_QT3DRENDER_QTEXTURELOADER_IDX                        = 163,
    SBK_QT3DRENDER_QTEXTURERECTANGLE_IDX                     = 164,
    SBK_QT3DRENDER_QTEXTUREWRAPMODE_WRAPMODE_IDX             = 166,
    SBK_QT3DRENDER_QTEXTUREWRAPMODE_IDX                      = 165,
    SBK_QT3DRENDER_QVIEWPORT_IDX                             = 167,
    SBK_QT3DRENDER_QWAITFENCE_HANDLETYPE_IDX                 = 169,
    SBK_QT3DRENDER_QWAITFENCE_IDX                            = 168,
    SBK_Qt3DRender_IDX_COUNT                                 = 170
};
...
enum : int {
    ...
    SBK_QT3DRENDER_QLIST_QOBJECTPTR_IDX                      = 4, // const QList<QObject* > &
    ...
    SBK_QT3DRENDER_QLIST_QREAL_IDX                           = 8, // const QList<qreal > &
    ...
    SBK_QT3DRENDER_QLIST_QT3DRENDER_QSORTPOLICY_SORTTYPE_IDX = 12, // const QList<Qt3DRender::QSortPolicy::SortType > &
    SBK_QT3DRENDER_QLIST_INT_IDX                             = 13, // const QList<int > &
