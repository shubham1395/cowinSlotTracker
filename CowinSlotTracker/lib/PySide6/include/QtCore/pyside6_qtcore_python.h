...
enum : int {
    ...
    SBK_QWINEVENTNOTIFIER_IDX                                = 298,
    SBK_QWRITELOCKER_IDX                                     = 299,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 300,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 301,
    SBK_QLIST_QXMLSTREAMATTRIBUTE_IDX                        = 301,
    SBK_QXMLSTREAMENTITYDECLARATION_IDX                      = 302,
    SBK_QXMLSTREAMENTITYRESOLVER_IDX                         = 303,
    SBK_QXMLSTREAMNAMESPACEDECLARATION_IDX                   = 304,
    SBK_QXMLSTREAMNOTATIONDECLARATION_IDX                    = 305,
    SBK_QXMLSTREAMREADER_TOKENTYPE_IDX                       = 309,
    SBK_QXMLSTREAMREADER_READELEMENTTEXTBEHAVIOUR_IDX        = 308,
    SBK_QXMLSTREAMREADER_ERROR_IDX                           = 307,
    SBK_QXMLSTREAMREADER_IDX                                 = 306,
    SBK_QXMLSTREAMWRITER_IDX                                 = 310,
    SBK_QT_GLOBALCOLOR_IDX                                   = 345,
    SBK_QT_MOUSEBUTTON_IDX                                   = 361,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 129,
    SBK_QT_ORIENTATION_IDX                                   = 366,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 131,
    SBK_QT_FOCUSPOLICY_IDX                                   = 340,
    SBK_QT_TABFOCUSBEHAVIOR_IDX                              = 379,
    SBK_QT_SORTORDER_IDX                                     = 377,
    SBK_QT_SPLITBEHAVIORFLAGS_IDX                            = 378,
    SBK_QFLAGS_QT_SPLITBEHAVIORFLAGS_IDX                     = 133,
    SBK_QT_TILERULE_IDX                                      = 384,
    SBK_QT_ALIGNMENTFLAG_IDX                                 = 312,
    SBK_QFLAGS_QT_ALIGNMENTFLAG_IDX                          = 116,
    SBK_QT_TEXTFLAG_IDX                                      = 381,
    SBK_QT_TEXTELIDEMODE_IDX                                 = 380,
    SBK_QT_WHITESPACEMODE_IDX                                = 393,
    SBK_QT_HITTESTACCURACY_IDX                               = 347,
    SBK_QT_WINDOWTYPE_IDX                                    = 398,
    SBK_QFLAGS_QT_WINDOWTYPE_IDX                             = 138,
    SBK_QT_WINDOWSTATE_IDX                                   = 397,
    SBK_QFLAGS_QT_WINDOWSTATE_IDX                            = 137,
    SBK_QT_APPLICATIONSTATE_IDX                              = 315,
    SBK_QFLAGS_QT_APPLICATIONSTATE_IDX                       = 117,
    SBK_QT_SCREENORIENTATION_IDX                             = 371,
    SBK_QFLAGS_QT_SCREENORIENTATION_IDX                      = 132,
    SBK_QT_WIDGETATTRIBUTE_IDX                               = 394,
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 314,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 348,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 123,
    SBK_QT_BGMODE_IDX                                        = 319,
    SBK_QT_KEY_IDX                                           = 355,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 356,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 127,
    SBK_QT_MODIFIER_IDX                                      = 360,
    SBK_QT_ARROWTYPE_IDX                                     = 316,
    SBK_QT_PENSTYLE_IDX                                      = 369,
    SBK_QT_PENCAPSTYLE_IDX                                   = 367,
    SBK_QT_PENJOINSTYLE_IDX                                  = 368,
    SBK_QT_BRUSHSTYLE_IDX                                    = 320,
    SBK_QT_SIZEMODE_IDX                                      = 376,
    SBK_QT_UIEFFECT_IDX                                      = 392,
    SBK_QT_CURSORSHAPE_IDX                                   = 329,
    SBK_QT_TEXTFORMAT_IDX                                    = 382,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 317,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 332,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 118,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 333,
    SBK_QT_TOOLBARAREA_IDX                                   = 387,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 135,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 388,
    SBK_QT_DATEFORMAT_IDX                                    = 330,
    SBK_QT_TIMESPEC_IDX                                      = 385,
    SBK_QT_DAYOFWEEK_IDX                                     = 331,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 372,
    SBK_QT_CASESENSITIVITY_IDX                               = 321,
    SBK_QT_CORNER_IDX                                        = 328,
    SBK_QT_EDGE_IDX                                          = 335,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 120,
    SBK_QT_CONNECTIONTYPE_IDX                                = 325,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 374,
    SBK_QT_FILLRULE_IDX                                      = 338,
    SBK_QT_MASKMODE_IDX                                      = 358,
    SBK_QT_CLIPOPERATION_IDX                                 = 324,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 353,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 354,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 391,
    SBK_QT_AXIS_IDX                                          = 318,
    SBK_QT_FOCUSREASON_IDX                                   = 341,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 326,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 350,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 125,
    SBK_QT_INPUTMETHODHINT_IDX                               = 349,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 124,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 336,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 389,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 357,
    SBK_QT_ANCHORPOINT_IDX                                   = 313,
    SBK_QT_FINDCHILDOPTION_IDX                               = 339,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 121,
    SBK_QT_DROPACTION_IDX                                    = 334,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 119,
    SBK_QT_CHECKSTATE_IDX                                    = 322,
    SBK_QT_ITEMDATAROLE_IDX                                  = 351,
    SBK_QT_ITEMFLAG_IDX                                      = 352,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 126,
    SBK_QT_MATCHFLAG_IDX                                     = 359,
    SBK_QFLAGS_QT_MATCHFLAG_IDX                              = 128,
    SBK_QT_WINDOWMODALITY_IDX                                = 396,
    SBK_QT_TEXTINTERACTIONFLAG_IDX                           = 383,
    SBK_QFLAGS_QT_TEXTINTERACTIONFLAG_IDX                    = 134,
    SBK_QT_EVENTPRIORITY_IDX                                 = 337,
    SBK_QT_SIZEHINT_IDX                                      = 375,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 395,
    SBK_QT_COORDINATESYSTEM_IDX                              = 327,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 390,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 136,
    SBK_QT_GESTURESTATE_IDX                                  = 343,
    SBK_QT_GESTURETYPE_IDX                                   = 344,
    SBK_QT_GESTUREFLAG_IDX                                   = 342,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 122,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 364,
    SBK_QT_NAVIGATIONMODE_IDX                                = 365,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 406,
    SBK_QT_TIMERTYPE_IDX                                     = 386,
    SBK_QT_SCROLLPHASE_IDX                                   = 373,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 363,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 362,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 130,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 323,
    SBK_QT_HIGHDPISCALEFACTORROUNDINGPOLICY_IDX              = 346,
    SBK_QT_RETURNBYVALUECONSTANT_IDX                         = 370,
    SBK_QtCoreQT_IDX                                         = 311,
    SBK_QTCOREHELPER_QMUTEXLOCKER_IDX                        = 400,
...
enum : int {
    ...
    SBK_QPTRDIFF_IDX                                         = 11,
    SBK_QUINTPTR_IDX                                         = 12,
    SBK_QTCORE_QLIST_QXMLSTREAMNAMESPACEDECLARATION_IDX      = 13, // const QList<QXmlStreamNamespaceDeclaration > &
    ...
    SBK_QTCORE_QLIST_QVARIANT_IDX                            = 27, // const QList<QVariant > &
    SBK_QTCORE_QLIST_QITEMSELECTIONRANGE_IDX                 = 28, // QList<QItemSelectionRange > &&
    SBK_QTCORE_QLIST_QOBJECTPTR_IDX                          = 29, // const QList<QObject* > &
    SBK_QTCORE_QLIST_QURL_IDX                                = 30, // const QList<QUrl > &
    ...
    SBK_QTCORE_QLIST_QCOMMANDLINEOPTION_IDX                  = 34, // const QList<QCommandLineOption > &
    SBK_QTCORE_QHASH_QSTRING_QVARIANT_IDX                    = 35, // const QHash<QString,QVariant > &
    SBK_QTCORE_QMAP_QSTRING_QVARIANT_IDX                     = 36, // const QMap<QString,QVariant > &
    SBK_QTCORE_QLIST_QCBORVALUE_IDX                          = 37, // QList<QCborValue >
    SBK_QTCORE_QMAP_INT_QVARIANT_IDX                         = 38, // QMap<int,QVariant >
    SBK_QTCORE_QLIST_QPERSISTENTMODELINDEX_IDX               = 39, // const QList<QPersistentModelIndex > &
