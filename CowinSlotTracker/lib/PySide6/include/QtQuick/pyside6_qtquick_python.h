...
// Type indices
enum : int {
    SBK_QQUICKASYNCIMAGEPROVIDER_IDX                         = 6,
    SBK_QQUICKFRAMEBUFFEROBJECT_IDX                          = 7,
    SBK_QQUICKFRAMEBUFFEROBJECT_RENDERER_IDX                 = 8,
    SBK_QQUICKIMAGEPROVIDER_IDX                              = 9,
    SBK_QQUICKIMAGERESPONSE_IDX                              = 10,
    SBK_QQUICKITEM_FLAG_IDX                                  = 12,
    SBK_QFLAGS_QQUICKITEM_FLAG_IDX                           = 0,
    SBK_QQUICKITEM_ITEMCHANGE_IDX                            = 13,
    SBK_QQUICKITEM_TRANSFORMORIGIN_IDX                       = 14,
    SBK_QQUICKITEM_IDX                                       = 11,
    SBK_QQUICKITEM_UPDATEPAINTNODEDATA_IDX                   = 15,
    SBK_QQUICKITEMGRABRESULT_IDX                             = 16,
    SBK_QQUICKPAINTEDITEM_RENDERTARGET_IDX                   = 19,
    SBK_QQUICKPAINTEDITEM_PERFORMANCEHINT_IDX                = 18,
    SBK_QFLAGS_QQUICKPAINTEDITEM_PERFORMANCEHINT_IDX         = 1,
    SBK_QQUICKPAINTEDITEM_IDX                                = 17,
    SBK_QQUICKRENDERCONTROL_IDX                              = 20,
    SBK_QQUICKTEXTDOCUMENT_IDX                               = 21,
    SBK_QQUICKTEXTUREFACTORY_IDX                             = 22,
    SBK_QQUICKTRANSFORM_IDX                                  = 23,
    SBK_QQUICKVIEW_RESIZEMODE_IDX                            = 25,
    SBK_QQUICKVIEW_STATUS_IDX                                = 26,
    SBK_QQUICKVIEW_IDX                                       = 24,
    SBK_QQUICKWINDOW_CREATETEXTUREOPTION_IDX                 = 28,
    SBK_QFLAGS_QQUICKWINDOW_CREATETEXTUREOPTION_IDX          = 2,
    SBK_QQUICKWINDOW_RENDERSTAGE_IDX                         = 29,
    SBK_QQUICKWINDOW_SCENEGRAPHERROR_IDX                     = 30,
    SBK_QQUICKWINDOW_TEXTRENDERTYPE_IDX                      = 31,
    SBK_QQUICKWINDOW_IDX                                     = 27,
    SBK_QSGBASICGEOMETRYNODE_IDX                             = 32,
    SBK_QSGCLIPNODE_IDX                                      = 33,
    SBK_QSGDYNAMICTEXTURE_IDX                                = 34,
    SBK_QSGGEOMETRY_ATTRIBUTETYPE_IDX                        = 38,
    SBK_QSGGEOMETRY_DATAPATTERN_IDX                          = 40,
    SBK_QSGGEOMETRY_DRAWINGMODE_IDX                          = 41,
    SBK_QSGGEOMETRY_TYPE_IDX                                 = 44,
    SBK_QSGGEOMETRY_IDX                                      = 35,
    SBK_QSGGEOMETRY_ATTRIBUTE_IDX                            = 36,
    SBK_QSGGEOMETRY_ATTRIBUTESET_IDX                         = 37,
    SBK_QSGGEOMETRY_COLOREDPOINT2D_IDX                       = 39,
    SBK_QSGGEOMETRY_POINT2D_IDX                              = 42,
    SBK_QSGGEOMETRY_TEXTUREDPOINT2D_IDX                      = 43,
    SBK_QSGGEOMETRYNODE_IDX                                  = 45,
    SBK_QSGMATERIALTYPE_IDX                                  = 46,
    SBK_QSGNODE_NODETYPE_IDX                                 = 50,
    SBK_QSGNODE_FLAG_IDX                                     = 49,
    SBK_QFLAGS_QSGNODE_FLAG_IDX                              = 4,
    SBK_QSGNODE_DIRTYSTATEBIT_IDX                            = 48,
    SBK_QFLAGS_QSGNODE_DIRTYSTATEBIT_IDX                     = 3,
    SBK_QSGNODE_IDX                                          = 47,
    SBK_QSGOPACITYNODE_IDX                                   = 51,
    SBK_QSGSIMPLERECTNODE_IDX                                = 52,
    SBK_QSGSIMPLETEXTURENODE_TEXTURECOORDINATESTRANSFORMFLAG_IDX = 54,
    SBK_QFLAGS_QSGSIMPLETEXTURENODE_TEXTURECOORDINATESTRANSFORMFLAG_IDX = 5,
    SBK_QSGSIMPLETEXTURENODE_IDX                             = 53,
    SBK_QSGTEXTURE_WRAPMODE_IDX                              = 58,
    SBK_QSGTEXTURE_FILTERING_IDX                             = 57,
    SBK_QSGTEXTURE_ANISOTROPYLEVEL_IDX                       = 56,
    SBK_QSGTEXTURE_IDX                                       = 55,
    SBK_QSGTEXTUREPROVIDER_IDX                               = 59,
    SBK_QSGTRANSFORMNODE_IDX                                 = 60,
    SBK_QSHAREDPOINTER_QQUICKITEMGRABRESULT_IDX              = 62, // QSharedPointer<QQuickItemGrabResult >
    SBK_QSHAREDPOINTER_CONSTQQUICKITEMGRABRESULT_IDX         = 62, //   (const)
    SBK_QtQuick_IDX_COUNT                                    = 63
};
