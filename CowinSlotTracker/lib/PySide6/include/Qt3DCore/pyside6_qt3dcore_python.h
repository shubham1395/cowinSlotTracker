...
enum : int {
    ...
    SBK_QT3DCORE_QENTITY_IDX                                 = 19,
    SBK_QT3DCORE_QGEOMETRY_IDX                               = 20,
    SBK_QT3DCORE_QGEOMETRYVIEW_PRIMITIVETYPE_IDX             = 22,
    SBK_QT3DCORE_QGEOMETRYVIEW_IDX                           = 21,
    SBK_QT3DCORE_QJOINT_IDX                                  = 23,
    SBK_QT3DCORE_QNODE_IDX                                   = 24,
    SBK_QT3DCORE_QNODEID_IDX                                 = 25,
    SBK_QT3DCORE_QNODEIDTYPEPAIR_IDX                         = 26,
    SBK_QT3DCORE_QSKELETON_IDX                               = 27,
    SBK_QT3DCORE_QSKELETONLOADER_STATUS_IDX                  = 29,
    SBK_QT3DCORE_QSKELETONLOADER_IDX                         = 28,
    SBK_QT3DCORE_QTRANSFORM_IDX                              = 30,
    SBK_Qt3DCore_IDX_COUNT                                   = 31
};
...
enum : int {
    ...
    SBK_QT3DCORE_QLIST_QOBJECTPTR_IDX                        = 1, // const QList<QObject* > &
    SBK_QT3DCORE_QLIST_QBYTEARRAY_IDX                        = 2, // QList<QByteArray >
    SBK_QT3DCORE_QLIST_QT3DCORE_QNODEPTR_IDX                 = 3, // QList<Qt3DCore::QNode* >
    SBK_QT3DCORE_QLIST_QT3DCORE_QNODEID_IDX                  = 4, // const QList<Qt3DCore::QNodeId > &
