...
enum : int {
    ...
    SBK_QT3DANIMATION_QLIST_QOBJECTPTR_IDX                   = 1, // const QList<QObject* > &
    ...
    SBK_QT3DANIMATION_QLIST_QT3DANIMATION_QMORPHTARGETPTR_IDX = 7, // QList<Qt3DAnimation::QMorphTarget* >
    SBK_QT3DANIMATION_QLIST_FLOAT_IDX                        = 8, // const QList<float > &
    SBK_QT3DANIMATION_QLIST_QT3DCORE_QTRANSFORMPTR_IDX       = 9, // QList<Qt3DCore::QTransform* >
