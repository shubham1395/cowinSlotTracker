...
enum : int {
    ...
    SBK_QSTYLEOPTIONMENUITEM_STYLEOPTIONTYPE_IDX             = 330,
    SBK_QSTYLEOPTIONMENUITEM_STYLEOPTIONVERSION_IDX          = 331,
    SBK_QSTYLEOPTIONMENUITEM_MENUITEMTYPE_IDX                = 329,
    SBK_QSTYLEOPTIONMENUITEM_CHECKTYPE_IDX                   = 328,
    SBK_QSTYLEOPTIONMENUITEM_IDX                             = 327,
    SBK_QSTYLEOPTIONPROGRESSBAR_STYLEOPTIONTYPE_IDX          = 333,
    SBK_QSTYLEOPTIONPROGRESSBAR_STYLEOPTIONVERSION_IDX       = 334,
    SBK_QSTYLEOPTIONPROGRESSBAR_IDX                          = 332,
    SBK_QSTYLEOPTIONRUBBERBAND_STYLEOPTIONTYPE_IDX           = 336,
    SBK_QSTYLEOPTIONRUBBERBAND_STYLEOPTIONVERSION_IDX        = 337,
    SBK_QSTYLEOPTIONRUBBERBAND_IDX                           = 335,
    SBK_QSTYLEOPTIONSIZEGRIP_STYLEOPTIONTYPE_IDX             = 339,
    SBK_QSTYLEOPTIONSIZEGRIP_STYLEOPTIONVERSION_IDX          = 340,
    SBK_QSTYLEOPTIONSIZEGRIP_IDX                             = 338,
    SBK_QSTYLEOPTIONSLIDER_STYLEOPTIONTYPE_IDX               = 342,
    SBK_QSTYLEOPTIONSLIDER_STYLEOPTIONVERSION_IDX            = 343,
    SBK_QSTYLEOPTIONSLIDER_IDX                               = 341,
    SBK_QSTYLEOPTIONSPINBOX_STYLEOPTIONTYPE_IDX              = 345,
    SBK_QSTYLEOPTIONSPINBOX_STYLEOPTIONVERSION_IDX           = 346,
    SBK_QSTYLEOPTIONSPINBOX_IDX                              = 344,
    SBK_QSTYLEOPTIONTAB_STYLEOPTIONTYPE_IDX                  = 350,
    SBK_QSTYLEOPTIONTAB_STYLEOPTIONVERSION_IDX               = 351,
    SBK_QSTYLEOPTIONTAB_TABPOSITION_IDX                      = 353,
    SBK_QSTYLEOPTIONTAB_SELECTEDPOSITION_IDX                 = 349,
    SBK_QSTYLEOPTIONTAB_CORNERWIDGET_IDX                     = 348,
    SBK_QFLAGS_QSTYLEOPTIONTAB_CORNERWIDGET_IDX              = 100,
    SBK_QSTYLEOPTIONTAB_TABFEATURE_IDX                       = 352,
    SBK_QFLAGS_QSTYLEOPTIONTAB_TABFEATURE_IDX                = 101,
    SBK_QSTYLEOPTIONTAB_IDX                                  = 347,
    SBK_QSTYLEOPTIONTABBARBASE_STYLEOPTIONTYPE_IDX           = 355,
    SBK_QSTYLEOPTIONTABBARBASE_STYLEOPTIONVERSION_IDX        = 356,
    SBK_QSTYLEOPTIONTABBARBASE_IDX                           = 354,
    SBK_QSTYLEOPTIONTABWIDGETFRAME_STYLEOPTIONTYPE_IDX       = 358,
    SBK_QSTYLEOPTIONTABWIDGETFRAME_STYLEOPTIONVERSION_IDX    = 359,
    SBK_QSTYLEOPTIONTABWIDGETFRAME_IDX                       = 357,
    SBK_QSTYLEOPTIONTITLEBAR_STYLEOPTIONTYPE_IDX             = 361,
    SBK_QSTYLEOPTIONTITLEBAR_STYLEOPTIONVERSION_IDX          = 362,
    SBK_QSTYLEOPTIONTITLEBAR_IDX                             = 360,
    SBK_QSTYLEOPTIONTOOLBAR_STYLEOPTIONTYPE_IDX              = 364,
    SBK_QSTYLEOPTIONTOOLBAR_STYLEOPTIONVERSION_IDX           = 365,
    SBK_QSTYLEOPTIONTOOLBAR_TOOLBARPOSITION_IDX              = 367,
    SBK_QSTYLEOPTIONTOOLBAR_TOOLBARFEATURE_IDX               = 366,
    SBK_QFLAGS_QSTYLEOPTIONTOOLBAR_TOOLBARFEATURE_IDX        = 102,
    SBK_QSTYLEOPTIONTOOLBAR_IDX                              = 363,
    SBK_QSTYLEOPTIONTOOLBOX_STYLEOPTIONTYPE_IDX              = 370,
    SBK_QSTYLEOPTIONTOOLBOX_STYLEOPTIONVERSION_IDX           = 371,
    SBK_QSTYLEOPTIONTOOLBOX_TABPOSITION_IDX                  = 372,
    SBK_QSTYLEOPTIONTOOLBOX_SELECTEDPOSITION_IDX             = 369,
    SBK_QSTYLEOPTIONTOOLBOX_IDX                              = 368,
    SBK_QSTYLEOPTIONTOOLBUTTON_STYLEOPTIONTYPE_IDX           = 374,
    SBK_QSTYLEOPTIONTOOLBUTTON_STYLEOPTIONVERSION_IDX        = 375,
    SBK_QSTYLEOPTIONTOOLBUTTON_TOOLBUTTONFEATURE_IDX         = 376,
    SBK_QFLAGS_QSTYLEOPTIONTOOLBUTTON_TOOLBUTTONFEATURE_IDX  = 103,
    SBK_QSTYLEOPTIONTOOLBUTTON_IDX                           = 373,
    SBK_QSTYLEOPTIONVIEWITEM_STYLEOPTIONTYPE_IDX             = 379,
    SBK_QSTYLEOPTIONVIEWITEM_STYLEOPTIONVERSION_IDX          = 380,
    SBK_QSTYLEOPTIONVIEWITEM_POSITION_IDX                    = 378,
    SBK_QSTYLEOPTIONVIEWITEM_VIEWITEMFEATURE_IDX             = 381,
    SBK_QFLAGS_QSTYLEOPTIONVIEWITEM_VIEWITEMFEATURE_IDX      = 104,
    SBK_QSTYLEOPTIONVIEWITEM_VIEWITEMPOSITION_IDX            = 382,
    SBK_QSTYLEOPTIONVIEWITEM_IDX                             = 377,
    SBK_QSTYLEPAINTER_IDX                                    = 383,
    SBK_QSTYLEDITEMDELEGATE_IDX                              = 384,
    SBK_QSWIPEGESTURE_SWIPEDIRECTION_IDX                     = 386,
    SBK_QSWIPEGESTURE_IDX                                    = 385,
    SBK_QSYSTEMTRAYICON_ACTIVATIONREASON_IDX                 = 388,
    SBK_QSYSTEMTRAYICON_MESSAGEICON_IDX                      = 389,
    SBK_QSYSTEMTRAYICON_IDX                                  = 387,
    SBK_QTABBAR_SHAPE_IDX                                    = 393,
    SBK_QTABBAR_BUTTONPOSITION_IDX                           = 391,
    SBK_QTABBAR_SELECTIONBEHAVIOR_IDX                        = 392,
    SBK_QTABBAR_IDX                                          = 390,
    SBK_QTABWIDGET_TABPOSITION_IDX                           = 395,
    SBK_QTABWIDGET_TABSHAPE_IDX                              = 396,
    SBK_QTABWIDGET_IDX                                       = 394,
    SBK_QTABLEVIEW_IDX                                       = 397,
    SBK_QTABLEWIDGET_IDX                                     = 398,
    SBK_QTABLEWIDGETITEM_ITEMTYPE_IDX                        = 400,
    SBK_QTABLEWIDGETITEM_IDX                                 = 399,
    SBK_QTABLEWIDGETSELECTIONRANGE_IDX                       = 401,
    SBK_QTAPANDHOLDGESTURE_IDX                               = 402,
    SBK_QTAPGESTURE_IDX                                      = 403,
    SBK_QTEXTBROWSER_IDX                                     = 404,
    SBK_QTEXTEDIT_LINEWRAPMODE_IDX                           = 408,
    SBK_QTEXTEDIT_AUTOFORMATTINGFLAG_IDX                     = 406,
    SBK_QFLAGS_QTEXTEDIT_AUTOFORMATTINGFLAG_IDX              = 105,
    SBK_QTEXTEDIT_IDX                                        = 405,
    SBK_QTEXTEDIT_EXTRASELECTION_IDX                         = 407,
    SBK_QTILERULES_IDX                                       = 409,
    SBK_QTIMEEDIT_IDX                                        = 410,
    SBK_QTOOLBAR_IDX                                         = 411,
    SBK_QTOOLBOX_IDX                                         = 412,
    SBK_QTOOLBUTTON_TOOLBUTTONPOPUPMODE_IDX                  = 414,
    SBK_QTOOLBUTTON_IDX                                      = 413,
    SBK_QTOOLTIP_IDX                                         = 415,
    SBK_QTREEVIEW_IDX                                        = 416,
    SBK_QTREEWIDGET_IDX                                      = 417,
    SBK_QTREEWIDGETITEM_ITEMTYPE_IDX                         = 420,
    SBK_QTREEWIDGETITEM_CHILDINDICATORPOLICY_IDX             = 419,
    SBK_QTREEWIDGETITEM_IDX                                  = 418,
    SBK_QTREEWIDGETITEMITERATOR_ITERATORFLAG_IDX             = 422,
    SBK_QFLAGS_QTREEWIDGETITEMITERATOR_ITERATORFLAG_IDX      = 106,
    SBK_QTREEWIDGETITEMITERATOR_IDX                          = 421,
    SBK_QUNDOVIEW_IDX                                        = 423,
    SBK_QVBOXLAYOUT_IDX                                      = 424,
    SBK_QWHATSTHIS_IDX                                       = 425,
    SBK_QWIDGET_RENDERFLAG_IDX                               = 427,
    SBK_QFLAGS_QWIDGET_RENDERFLAG_IDX                        = 107,
    SBK_QWIDGET_IDX                                          = 426,
    SBK_QWIDGETACTION_IDX                                    = 428,
    SBK_QWIDGETITEM_IDX                                      = 429,
    SBK_QWIZARD_WIZARDBUTTON_IDX                             = 431,
    SBK_QWIZARD_WIZARDPIXMAP_IDX                             = 433,
    SBK_QWIZARD_WIZARDSTYLE_IDX                              = 434,
    SBK_QWIZARD_WIZARDOPTION_IDX                             = 432,
    SBK_QFLAGS_QWIZARD_WIZARDOPTION_IDX                      = 108,
    SBK_QWIZARD_IDX                                          = 430,
    SBK_QWIZARDPAGE_IDX                                      = 435,
    SBK_QtWidgets_IDX_COUNT                                  = 436
};
...
// Converter indices
enum : int {
    SBK_QTWIDGETS_QLIST_QTREEWIDGETITEMPTR_IDX               = 0, // const QList<QTreeWidgetItem* > &
    SBK_QTWIDGETS_QLIST_QCOLOR_IDX                           = 1, // const QList<QColor >
    ...
    SBK_QTWIDGETS_QLIST_QGRAPHICSTRANSFORMPTR_IDX            = 5, // const QList<QGraphicsTransform* > &
    SBK_QTWIDGETS_QLIST_QLINE_IDX                            = 6, // const QList<QLine > &
    SBK_QTWIDGETS_QLIST_QLINEF_IDX                           = 7, // const QList<QLineF > &
    SBK_QTWIDGETS_QLIST_QPOINT_IDX                           = 8, // const QList<QPoint > &
    SBK_QTWIDGETS_QLIST_QPOINTF_IDX                          = 9, // const QList<QPointF > &
    SBK_QTWIDGETS_QLIST_QRECT_IDX                            = 10, // const QList<QRect > &
    SBK_QTWIDGETS_QLIST_QRECTF_IDX                           = 11, // const QList<QRectF > &
    SBK_QTWIDGETS_QLIST_QACTIONPTR_IDX                       = 12, // QList<QAction* >
    SBK_QTWIDGETS_QLIST_QOBJECTPTR_IDX                       = 13, // const QList<QObject* > &
    SBK_QTWIDGETS_QLIST_QBYTEARRAY_IDX                       = 14, // QList<QByteArray >
    SBK_QTWIDGETS_QLIST_QDOCKWIDGETPTR_IDX                   = 15, // const QList<QDockWidget* > &
    SBK_QTWIDGETS_QLIST_INT_IDX                              = 16, // const QList<int > &
    ...
    SBK_QTWIDGETS_QLIST_QWIZARD_WIZARDBUTTON_IDX             = 24, // const QList<QWizard::WizardButton > &
    ...
    SBK_QTWIDGETS_QLIST_QREAL_IDX                            = 27, // const QList<qreal > &
    ...
    SBK_QTWIDGETS_QLIST_QKEYSEQUENCE_IDX                     = 33, // const QList<QKeySequence > &
    SBK_QTWIDGETS_QLIST_QGESTUREPTR_IDX                      = 34, // const QList<QGesture* > &
    ...
    SBK_QTWIDGETS_QLIST_QPERSISTENTMODELINDEX_IDX            = 39, // const QList<QPersistentModelIndex > &
