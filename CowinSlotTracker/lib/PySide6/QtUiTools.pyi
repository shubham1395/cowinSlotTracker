...
class QUiLoader(PySide6.QtCore.QObject):
    ...
    def createAction(self, parent:typing.Optional[PySide6.QtCore.QObject]=..., name:str=...) -> PySide6.QtGui.QAction: ...
    def createActionGroup(self, parent:typing.Optional[PySide6.QtCore.QObject]=..., name:str=...) -> PySide6.QtGui.QActionGroup: ...
    def createLayout(self, className:str, parent:typing.Optional[PySide6.QtCore.QObject]=..., name:str=...) -> PySide6.QtWidgets.QLayout: ...
    def createWidget(self, className:str, parent:typing.Optional[PySide6.QtWidgets.QWidget]=..., name:str=...) -> PySide6.QtWidgets.QWidget: ...
    def errorString(self) -> str: ...
    def isLanguageChangeEnabled(self) -> bool: ...
    def isTranslationEnabled(self) -> bool: ...
    @typing.overload
    def load(self, arg__1:str, parentWidget:typing.Optional[PySide6.QtWidgets.QWidget]=...) -> PySide6.QtWidgets.QWidget: ...
    @typing.overload
    def load(self, device:PySide6.QtCore.QIODevice, parentWidget:typing.Optional[PySide6.QtWidgets.QWidget]=...) -> PySide6.QtWidgets.QWidget: ...
