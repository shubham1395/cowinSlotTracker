...
class Qt3DExtras(Shiboken.Object):
    ...
    class QAbstractCameraController(PySide6.Qt3DCore.QEntity):
    ...
    class QAbstractSpriteSheet(PySide6.Qt3DCore.QNode):
    ...
    class QConeGeometry(PySide6.Qt3DCore.QGeometry):
    ...
    class QConeMesh(PySide6.Qt3DRender.QGeometryRenderer):
    ...
    class QCuboidGeometry(PySide6.Qt3DCore.QGeometry):
    ...
    class QCuboidMesh(PySide6.Qt3DRender.QGeometryRenderer):
    ...
    class QCylinderGeometry(PySide6.Qt3DCore.QGeometry):
    ...
    class QCylinderMesh(PySide6.Qt3DRender.QGeometryRenderer):
    ...
    class QDiffuseMapMaterial(PySide6.Qt3DRender.QMaterial):

        def __init__(self, parent:typing.Optional[PySide6.Qt3DCore.Qt3DCore.QNode]=...) -> None: ...

        def ambient(self) -> PySide6.QtGui.QColor: ...
        def diffuse(self) -> PySide6.Qt3DRender.Qt3DRender.QAbstractTexture: ...
        def setAmbient(self, color:PySide6.QtGui.QColor) -> None: ...
        ...
        def setSpecular(self, specular:PySide6.QtGui.QColor) -> None: ...
        def setTextureScale(self, textureScale:float) -> None: ...
        def shininess(self) -> float: ...
        def specular(self) -> PySide6.QtGui.QColor: ...
        def textureScale(self) -> float: ...

    class QDiffuseSpecularMapMaterial(PySide6.Qt3DRender.QMaterial):

        def __init__(self, parent:typing.Optional[PySide6.Qt3DCore.Qt3DCore.QNode]=...) -> None: ...

        def ambient(self) -> PySide6.QtGui.QColor: ...
        def diffuse(self) -> PySide6.Qt3DRender.Qt3DRender.QAbstractTexture: ...
        def setAmbient(self, ambient:PySide6.QtGui.QColor) -> None: ...
        def setDiffuse(self, diffuse:PySide6.Qt3DRender.Qt3DRender.QAbstractTexture) -> None: ...
        def setShininess(self, shininess:float) -> None: ...
    ...
    class QDiffuseSpecularMaterial(PySide6.Qt3DRender.QMaterial):
    ...
    class QExtrudedTextGeometry(PySide6.Qt3DCore.QGeometry):
    ...
    class QExtrudedTextMesh(PySide6.Qt3DRender.QGeometryRenderer):
    ...
    class QFirstPersonCameraController(PySide6.Qt3DExtras.QAbstractCameraController):

        def __init__(self, parent:typing.Optional[PySide6.Qt3DCore.Qt3DCore.QNode]=...) -> None: ...


    class QForwardRenderer(PySide6.Qt3DRender.QTechniqueFilter):
        ...
        def setClearColor(self, clearColor:PySide6.QtGui.QColor) -> None: ...
        ...
        def setViewportRect(self, viewportRect:PySide6.QtCore.QRectF) -> None: ...
        def showDebugOverlay(self) -> bool: ...
        def surface(self) -> PySide6.QtCore.QObject: ...
        def viewportRect(self) -> PySide6.QtCore.QRectF: ...

    class QGoochMaterial(PySide6.Qt3DRender.QMaterial):
        ...
        def setCool(self, cool:PySide6.QtGui.QColor) -> None: ...
        def setDiffuse(self, diffuse:PySide6.QtGui.QColor) -> None: ...
        def setShininess(self, shininess:float) -> None: ...
        def setSpecular(self, specular:PySide6.QtGui.QColor) -> None: ...
        def setWarm(self, warm:PySide6.QtGui.QColor) -> None: ...
        def shininess(self) -> float: ...
        def specular(self) -> PySide6.QtGui.QColor: ...
        def warm(self) -> PySide6.QtGui.QColor: ...

    class QMetalRoughMaterial(PySide6.Qt3DRender.QMaterial):
    ...
    class QMorphPhongMaterial(PySide6.Qt3DRender.QMaterial):
    ...
    class QNormalDiffuseMapAlphaMaterial(PySide6.Qt3DExtras.QNormalDiffuseMapMaterial):

        def __init__(self, parent:typing.Optional[PySide6.Qt3DCore.Qt3DCore.QNode]=...) -> None: ...


    class QNormalDiffuseMapMaterial(PySide6.Qt3DRender.QMaterial):
    ...
    class QNormalDiffuseSpecularMapMaterial(PySide6.Qt3DRender.QMaterial):
    ...
    class QOrbitCameraController(PySide6.Qt3DExtras.QAbstractCameraController):
    ...
    class QPerVertexColorMaterial(PySide6.Qt3DRender.QMaterial):

        def __init__(self, parent:typing.Optional[PySide6.Qt3DCore.Qt3DCore.QNode]=...) -> None: ...


    class QPhongAlphaMaterial(PySide6.Qt3DRender.QMaterial):
    ...
    class QPhongMaterial(PySide6.Qt3DRender.QMaterial):
    ...
    class QPlaneGeometry(PySide6.Qt3DCore.QGeometry):
    ...
    class QPlaneMesh(PySide6.Qt3DRender.QGeometryRenderer):
    ...
    class QSkyboxEntity(PySide6.Qt3DCore.QEntity):
    ...
    class QSphereGeometry(PySide6.Qt3DCore.QGeometry):
    ...
    class QSphereMesh(PySide6.Qt3DRender.QGeometryRenderer):
    ...
    class QSpriteGrid(PySide6.Qt3DExtras.QAbstractSpriteSheet):
    ...
    class QSpriteSheet(PySide6.Qt3DExtras.QAbstractSpriteSheet):
        ...
        def setSprites(self, sprites:typing.Sequence) -> None: ...
        def sprites(self) -> typing.List: ...

    class QSpriteSheetItem(PySide6.Qt3DCore.QNode):
    ...
    class QText2DEntity(PySide6.Qt3DCore.QEntity):
    ...
    class QTextureMaterial(PySide6.Qt3DRender.QMaterial):
    ...
    class QTorusGeometry(PySide6.Qt3DCore.QGeometry):
    ...
    class QTorusMesh(PySide6.Qt3DRender.QGeometryRenderer):
    ...
    class Qt3DWindow(PySide6.QtGui.QWindow):
        ...
        def __init__(self, screen:typing.Optional[PySide6.QtGui.QScreen]=..., arg__2:PySide6.Qt3DRender.Qt3DRender.API=...) -> None: ...
